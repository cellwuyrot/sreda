...
const GROUPS: NavGroup[] = [
  {
    ...
    label: "Контент сайта",
    items: [
      { title: "Правовая информация", description: "Редактируется в блоках «О проекте»", href: "/admin/about", icon: <Icon path={<><path d="M6 3h9l3 3v15H6z" /><path d="M9 9h6M9 13h6M9 17h4" /></>} /> },
      { title: "О проекте и правовая информация", description: "Тексты и блоки страницы /about", href: "/admin/about", icon: <Icon path={<><circle cx="12" cy="12" r="9" /><path d="M12 3a15 15 0 0 1 0 18M12 3a15 15 0 0 0 0 18M3 12h18" /></>} /> },
