...
const GROUPS: NavGroup[] = [
  {
    ...
    label: "Контент сайта",
    items: [
      { title: "Правовая информация", description: "Пользовательское соглашение и контакты", href: "/admin/legal", icon: <Icon path={<><path d="M6 3h9l3 3v15H6z" /><path d="M9 9h6M9 13h6M9 17h4" /></>} /> },
