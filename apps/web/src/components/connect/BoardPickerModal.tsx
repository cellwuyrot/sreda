...
/**
 * FIX-BOARDPICKER: модальный выбор холста назначения при клике «Отправить на доску».
 *
 * Показывает:
 *   – Личная рабочая среда (+ список холстов)
 *   – Для каждого канвас-канала группы: название + список холстов
 */
...
export type BoardSelection = {
  ...
  /** Только для группового холста: ID канвас-канала */
  channelId?: string;
};
      ...
      >
        ...
        <div className="flex items-center gap-2 px-4 pt-4 pb-3 border-b border-neutral-100 dark:border-neutral-800">
          <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <rect x="14" y="14" width="7" height="7" rx="1" /><path d="M14 6.5h7" /><path d="M17.5 3v7" />
          </svg>
        ...
        <div className="overflow-y-auto flex-1 py-2">
          ...
          {list && (
            <>
              ...
              />
              {open["personal"] && list.personal.boards.map((b) => (
                <BoardRow
                  key={b.id}
                  name={b.name}
              ...
              {list.group.length === 0 && groupId === undefined && (
