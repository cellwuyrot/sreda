...
import { ABOUT_DEFAULTS, ABOUT_SECTIONS, aboutKeys, buildAboutContent } from "../lib/about";
...
check("\u0441\u0435\u043a\u0446\u0438\u0438 \u0438\u0437 \u043f\u0440\u0435\u0436\u043d\u0435\u0439 \u0432\u0435\u0440\u0441\u0438\u0438 \u0441\u043e\u0445\u0440\u0430\u043d\u0435\u043d\u044b \u0446\u0435\u043b\u0438\u043a\u043e\u043c", () => {
  assert(ABOUT_SECTIONS.length === 4, "\u043f\u043e\u0442\u0435\u0440\u044f\u043d\u044b \u043d\u0430\u043f\u0440\u0430\u0432\u043b\u0435\u043d\u0438\u044f \u044d\u043a\u043e\u0441\u0438\u0441\u0442\u0435\u043c\u044b");
  for (const section of ABOUT_SECTIONS) {
    assert(section.title.trim().length > 0, "\u043f\u0443\u0441\u0442\u043e\u0439 \u0437\u0430\u0433\u043e\u043b\u043e\u0432\u043e\u043a: " + section.key);
    assert(section.description.trim().length > 40, "\u043f\u0443\u0441\u0442\u043e\u0435 \u043e\u043f\u0438\u0441\u0430\u043d\u0438\u0435: " + section.key);
    assert(section.href.startsWith("/"), "\u0441\u043b\u043e\u043c\u0430\u043d\u0430 \u0441\u0441\u044b\u043b\u043a\u0430: " + section.key);
  }
});

check("\u0442\u0435\u043a\u0441\u0442 \u0441\u0442\u0440\u0430\u043d\u0438\u0446\u044b \u0435\u0441\u0442\u044c \u0434\u0430\u0436\u0435 \u043f\u0440\u0438 \u043f\u0443\u0441\u0442\u043e\u0439 \u0431\u0430\u0437\u0435", () => {
  for (const content of [buildAboutContent(null), buildAboutContent({})]) {
    assert(content.title === ABOUT_DEFAULTS.title, "\u0437\u0430\u0433\u043b\u0430\u0432\u0438\u0435 \u043f\u043e\u0442\u0435\u0440\u044f\u043d\u043e");
    assert(content.subtitle.length > 40, "\u043f\u043e\u0434\u0437\u0430\u0433\u043e\u043b\u043e\u0432\u043e\u043a \u043f\u0443\u0441\u0442");
    assert(content.sections.length === 4, "\u043a\u0430\u0440\u0442\u043e\u0447\u043a\u0438 \u043d\u0435 \u0441\u043e\u0431\u0440\u0430\u043b\u0438\u0441\u044c");
    assert(content.footer.trim().length > 0, "\u043f\u043e\u0434\u043f\u0438\u0441\u044c \u043f\u0443\u0441\u0442\u0430");
  }
});

check("\u0430\u0434\u043c\u0438\u043d\u043a\u0430 \u043f\u0435\u0440\u0435\u043a\u0440\u044b\u0432\u0430\u0435\u0442 \u0442\u0435\u043a\u0441\u0442 \u043f\u043e\u043b\u0435-\u0437\u0430-\u043f\u043e\u043b\u0435", () => {
  const first = ABOUT_SECTIONS[0];
  const content = buildAboutContent({
    [aboutKeys.title]: "\u0421\u0432\u043e\u0451 \u0437\u0430\u0433\u043b\u0430\u0432\u0438\u0435",
    [aboutKeys.subtitle]: "   ",
    [aboutKeys.sectionDesc(first.key)]: "\u041e\u043f\u0438\u0441\u0430\u043d\u0438\u0435 \u0438\u0437 \u0430\u0434\u043c\u0438\u043d\u043a\u0438.",
  });
  assert(content.title === "\u0421\u0432\u043e\u0451 \u0437\u0430\u0433\u043b\u0430\u0432\u0438\u0435", "\u043f\u0440\u0430\u0432\u043a\u0430 \u0438\u0437 \u0430\u0434\u043c\u0438\u043d\u043a\u0438 \u043f\u043e\u0442\u0435\u0440\u044f\u043d\u0430");
  assert(content.subtitle === ABOUT_DEFAULTS.subtitle, "\u043f\u0443\u0441\u0442\u043e\u0435 \u043f\u043e\u043b\u0435 \u0437\u0430\u0442\u0451\u0440\u043b\u043e \u0442\u0435\u043a\u0441\u0442");
  assert(content.sections[0].description === "\u041e\u043f\u0438\u0441\u0430\u043d\u0438\u0435 \u0438\u0437 \u0430\u0434\u043c\u0438\u043d\u043a\u0438.", "\u043e\u043f\u0438\u0441\u0430\u043d\u0438\u0435 \u0441\u0435\u043a\u0446\u0438\u0438 \u043d\u0435 \u043f\u0435\u0440\u0435\u043a\u0440\u044b\u0432\u0430\u0435\u0442\u0441\u044f");
  assert(content.sections[0].title === first.title, "\u0437\u0430\u0433\u043e\u043b\u043e\u0432\u043e\u043a \u0441\u0435\u043a\u0446\u0438\u0438 \u0441\u043b\u043e\u043c\u0430\u043d");
});

check("\u0441\u0435\u043a\u0446\u0438\u0438 \u0438 \u0431\u043b\u043e\u043a\u0438 \u0436\u0438\u0432\u0443\u0442 \u0440\u044f\u0434\u043e\u043c, \u0430 \u043d\u0435 \u0432\u0437\u0430\u043c\u0435\u043d", () => {
  const legacy = readFileSync("src/components/about/LegacyAboutSections.tsx", "utf8");
  assert(!/fetch\(/.test(legacy), "\u0441\u0435\u043a\u0446\u0438\u0438 \u0433\u0440\u0443\u0437\u044f\u0442\u0441\u044f \u0437\u0430\u043f\u0440\u043e\u0441\u043e\u043c");
  assert(!/useEffect|useState/.test(legacy), "\u0441\u0435\u043a\u0446\u0438\u0438 \u0437\u0430\u0432\u0438\u0441\u044f\u0442 \u043e\u0442 \u043a\u043b\u0438\u0435\u043d\u0442\u0441\u043a\u043e\u0433\u043e \u0441\u043e\u0441\u0442\u043e\u044f\u043d\u0438\u044f");
  assert(legacy.includes("content.sections.map"), "\u043a\u0430\u0440\u0442\u043e\u0447\u043a\u0438 \u043d\u0435 \u0440\u0438\u0441\u0443\u044e\u0442\u0441\u044f");
  const client = readFileSync("src/components/about/AboutPageClient.tsx", "utf8");
  const iLegacy = client.indexOf("<LegacyAboutSections");
  const iBlocks = client.indexOf("{bodyBlocks.map(renderBlock)}");
  assert(iLegacy > 0 && iBlocks > 0, "\u043e\u0434\u043d\u0430 \u0438\u0437 \u0447\u0430\u0441\u0442\u0435\u0439 \u0441\u0442\u0440\u0430\u043d\u0438\u0446\u044b \u043f\u0440\u043e\u043f\u0430\u043b\u0430");
  assert(iLegacy < iBlocks, "\u0441\u0435\u043a\u0446\u0438\u0438 \u0434\u043e\u043b\u0436\u043d\u044b \u0431\u044b\u0442\u044c \u0432\u044b\u0448\u0435 \u0431\u043b\u043e\u043a\u043e\u0432");
  const page = readFileSync("src/app/about/page.tsx", "utf8");
  assert(page.includes('startsWith: "content:about."'), "\u0442\u0435\u043a\u0441\u0442 \u0441\u0435\u043a\u0446\u0438\u0439 \u043d\u0435 \u0447\u0438\u0442\u0430\u0435\u0442\u0441\u044f \u0438\u0437 \u0430\u0434\u043c\u0438\u043d\u043a\u0438");
  assert(page.includes('startsWith: "content:legal."'), "\u043f\u0440\u0430\u0432\u043e\u0432\u044b\u0435 \u043a\u043b\u044e\u0447\u0438 \u043f\u0435\u0440\u0435\u0441\u0442\u0430\u043b\u0438 \u0447\u0438\u0442\u0430\u0442\u044c\u0441\u044f");
