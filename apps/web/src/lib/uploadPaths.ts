...
export const PRIVATE_UPLOAD_DIRS = [
  ...
  "workspace",
  /* FIX-WALLMEDIA: вложения записей на стене профиля. Стену читает вошедший
     пользователь, но не тот, кто в чёрном списке, — значит файл тоже нельзя
     раздавать статикой без проверки сессии. */
  "wall",
] as const;
