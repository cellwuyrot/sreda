...
export const BLOCK_DEFAULTS: BlockDataMap = {
  ...
  legal: {
    ...
    sections: [
      { title: '1. Термины и определения', content: 'Платформа (Сайт) — совокупность программно-аппаратных средств, размещённых на trioz.ru.
...
Пользователь — любое дееспособное физическое лицо или представитель юридического лица, использующий Платформу.' },
      { title: '2. Предмет соглашения', content: '2.1. Предметом является предоставление доступа к функциональным возможностям Платформы trioz.ru.

2.2. Использование Платформы означает безоговорочное согласие со всеми условиями настоящего Соглашения.' },
      { title: '3. Порядок использования', content: '3.1. Пользователь вправе направлять сообщения через формы обратной связи.
...
3.3. Время рассмотрения обращений — не более 30 календарных дней.' },
      { title: '4. Политика ведения деятельности', content: '4.1. TRIOZ строит деятельность на принципах законности, прозрачности, конфиденциальности и этики.

4.2. Запрещено: спам, вредоносные программы, оскорбительные материалы, несанкционированный доступ, автоматический сбор данных.' },
      { title: '5. Интеллектуальная собственность', content: 'Все элементы Платформы trioz.ru являются объектами исключительных прав Администрации. Копирование без согласия запрещено.' },
      { title: '6. Ограничение ответственности', content: 'Платформа предоставляется "как есть" (as is). Администрация не несёт ответственности за убытки, возникшие в связи с использованием сервиса.' },
      { title: '7. Персональные данные', content: '7.1. Обработка персональных данных осуществляется в соответствии с ФЗ № 152-ФЗ "О персональных данных".

7.2. Категории: имя, e-mail, телефон, IP-адрес, cookie.' },
      { title: '8. Разрешение споров', content: '8.1. Споры разрешаются путём переговоров, срок рассмотрения претензии — 15 рабочих дней.
