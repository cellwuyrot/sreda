...
export interface GroupTheme {
	...
	priority: boolean;
	/** Текстовый канал, который открывается по умолчанию при входе. */
...
export function normalizeGroupTheme(raw: unknown): GroupTheme {
	...
	return {
		...
		defaultChannelId: typeof r.defaultChannelId === "string" ? r.defaultChannelId.slice(0, 40) : base.defaultChannelId,
