...
exports.IPC = exports.PROTOCOL = exports.BLOCKED_PATHS = exports.DEFAULT_START_PATH = exports.LEGACY_APP_URLS = exports.DEFAULT_APP_URL = exports.SOCKET_EVENTS = exports.SOCKET_PATH = void 0;
...
var shared_1 = require("@trioz/shared");
Object.defineProperty(exports, "SOCKET_PATH", { enumerable: true, get: function () { return shared_1.SOCKET_PATH; } });
Object.defineProperty(exports, "SOCKET_EVENTS", { enumerable: true, get: function () { return shared_1.SOCKET_EVENTS; } });
/** Default web frontend origin to load when nothing is configured. */
exports.DEFAULT_APP_URL = "https://trioz.ru";
/**
 ...
 */
exports.LEGACY_APP_URLS = ["https://connect.trioz.ru", "http://connect.trioz.ru"];
/**
 ...
 */
exports.DEFAULT_START_PATH = "/connect";
/**
 ...
 */
exports.BLOCKED_PATHS = ["/projects", "/pero", "/library"];
/** Custom protocol used for deep links, e.g. `trioz://invite/abc123`. */
exports.PROTOCOL = "trioz";
/**
